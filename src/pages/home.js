...
export function renderHome() {
  const E = getLang() === 'ru';
  return '<section class="hero"><div class="hero-bg" id="hero-bg" role="img" aria-label="Travel destinations around the world" style="background-image:url(\'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=1920&q=75&fm=webp\')"></div><div class="hero-c"><div style="display:inline-flex;align-items:center;gap:8px;padding:8px 20px;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.15);border-radius:100px;margin-bottom:32px"><span style="font-size:13px;font-weight:600;color:rgba(255,255,255,.8)">' + (E ? 'Для турагентов и туроператоров' : 'For travel agents & tour operators') + '</span></div><h1>' + (E ? '<span class="hero-line">Один партнёр.</span><span class="hero-line"><em>13+ направлений.</em></span><span class="hero-line">Прямые цены.</span>' : '<span class="hero-line">One partner.</span><span class="hero-line"><em>13+ destinations.</em></span><span class="hero-line">Direct rates.</span>') + '</h1><p class="hero-sub">' + (E ? 'Мы берём на себя отели, трансферы, экскурсии и пакеты — вы зарабатываете. Ответ за 2 часа.' : 'We handle hotels, transfers, excursions and packages — you keep the margin. Response in 2 hours.') + '</p><div class="hero-act"><a class="bp" data-nav="partner">' + (E ? 'Стать партнёром \u2192' : 'Become a partner \u2192') + '</a><a class="bs" data-scroll="dest" style="color:#fff">' + (E ? 'Направления' : 'Explore destinations') + '</a></div><div class="hero-dots"><div class="hero-dot active" data-hero="0"></div><div class="hero-dot" data-hero="1"></div><div class="hero-dot" data-hero="2"></div><div class="hero-dot" data-hero="3"></div><div class="hero-dot" data-hero="4"></div></div></div></section>' +
    trustBar() +
    whyPartner() +
    destinationsGrid() +
    svcTabsSection() +
