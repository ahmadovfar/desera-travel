...
export function testimonials() {
  ...
  return '<div class="test-grid">' + t.map(function (x) { return '<div class="test-card anim"><div class="test-q">"' + x.q + '"</div><div class="test-author"><div class="test-av">' + x.i + '</div><div><div class="test-name">' + x.n + '</div><div class="test-role">' + x.r + '</div></div></div></div>'; }).join('') + '</div>';
}
